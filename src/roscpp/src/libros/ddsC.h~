...
#ifndef _TAO_IDL_DDSC_NLTBUJ_H_
#define _TAO_IDL_DDSC_NLTBUJ_H_
...
namespace ROSDDS
{
  ...
  struct  Msg
  {
    ...
    ::CORBA::Octet reserved;
    CORBA::ULongSeq version;
    ::TAO::String_Manager callerId;
    CORBA::OctetSeq message;
  };
