...
void gen_find_size(const ROSDDS::Msg& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(ACE_OutputCDR::from_octet(stru.reserved));
  gen_find_size(stru.version, size, padding);
  find_size_ulong(size, padding);
  size += ACE_OS::strlen(stru.callerId) + 1;
...
bool operator<<(Serializer& strm, const ROSDDS::Msg& stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm << ACE_OutputCDR::from_octet(stru.reserved))
    && (strm << stru.version)
    && (strm << stru.callerId)
    && (strm << stru.message);
}
...
bool operator>>(Serializer& strm, ROSDDS::Msg& stru)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(stru);
  return (strm >> ACE_InputCDR::to_octet(stru.reserved))
    && (strm >> stru.version)
    && (strm >> stru.callerId.out())
    && (strm >> stru.message);
}
...
struct MetaStructImpl<ROSDDS::Msg> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "reserved") == 0) {
      return typed.reserved;
    }
    if (std::strcmp(field, "callerId") == 0) {
      return typed.callerId.in();
    }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    if (std::strcmp(field, "reserved") == 0) {
      ...
      if (!(ser >> ACE_InputCDR::to_octet(val))) {
        throw std::runtime_error("Field 'reserved' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 1);
    ...
    if (std::strcmp(field, "callerId") == 0) {
      ...
      if (!(ser >> val.out())) {
        throw std::runtime_error("Field 'callerId' could not be deserialized");
      }
      return val;
    } else {
      ACE_CDR::ULong len;
      if (!(ser >> len)) {
        throw std::runtime_error("String 'callerId' length could not be deserialized");
      }
      ser.skip(len);
    }
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ACE_UNUSED_ARG(next);
    if (std::strcmp(field, "reserved") == 0) {
      return make_field_cmp(&T::reserved, next);
    }
    if (std::strcmp(field, "callerId") == 0) {
      return make_field_cmp(&T::callerId, next);
    }
    throw std::runtime_error("Field " + std::string(field) + " not found or its type is not supported (in struct ROSDDS::Msg)");
  }
  ...
  {
    static const char* names[] = {"reserved", "version", "callerId", "message", 0};
    return names;
  }
  ...
  {
    if (std::strcmp(field, "reserved") == 0) {
      return &static_cast<const T*>(stru)->reserved;
    }
    if (std::strcmp(field, "version") == 0) {
      return &static_cast<const T*>(stru)->version;
    }
    if (std::strcmp(field, "callerId") == 0) {
      return &static_cast<const T*>(stru)->callerId;
    }
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "reserved") == 0) {
      static_cast<T*>(lhs)->reserved = *static_cast<const CORBA::Octet*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "version") == 0) {
      static_cast<T*>(lhs)->version = *static_cast<const CORBA::ULongSeq*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "callerId") == 0) {
      static_cast<T*>(lhs)->callerId = *static_cast<const TAO::String_Manager*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "message") == 0) {
      static_cast<T*>(lhs)->message = *static_cast<const CORBA::OctetSeq*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    throw std::runtime_error("Field " + std::string(field) + " not found or its type is not supported (in struct ROSDDS::Msg)");
  }
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    ACE_UNUSED_ARG(rhs);
    if (std::strcmp(field, "reserved") == 0) {
      return static_cast<const T*>(lhs)->reserved == static_cast<const T*>(rhs)->reserved;
    }
    if (std::strcmp(field, "callerId") == 0) {
      return 0 == ACE_OS::strcmp(static_cast<const T*>(lhs)->callerId, static_cast<const T*>(rhs)->callerId);
    }
    throw std::runtime_error("Field " + std::string(field) + " not found or its type is not supported (in struct ROSDDS::Msg)");
  }
};
